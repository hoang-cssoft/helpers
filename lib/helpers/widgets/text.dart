...
class Subtitle1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
        ...
        textWidthBasis: textWidthBasis,
        semanticsLabel: semanticsLabel,
        style: context.textTheme.subheadStyle!.merge(style));
  }
}
...
class Subtitle2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
        ...
        textWidthBasis: textWidthBasis,
        semanticsLabel: semanticsLabel,
        style: context.textTheme.subtitleStyle!.merge(style));
  }
}
...
class CaptionText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
        ...
        textWidthBasis: textWidthBasis,
        semanticsLabel: semanticsLabel,
        style: context.textTheme.captionStyle!.merge(style));
  }
}
...
class ButtonText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
        ...
        textWidthBasis: textWidthBasis,
        semanticsLabel: semanticsLabel,
        style: context.textTheme.buttonStyle!.merge(style));
  }
}
...
class OverlineText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      ...
      textWidthBasis: textWidthBasis,
      semanticsLabel: semanticsLabel,
      style: context.textTheme.overlineStyle!.merge(style),
    );
  }
}
